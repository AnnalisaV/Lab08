...
public class ExtFlightDelaysDAO {
	...
	public List<CoppiaAirports> getAirportsCollegati(Map<Integer, Airport> idMap){
		String sql="SELECT origin_airport_id, destination_airport_id, AVG(DISTANCE) AS peso " + 
				"FROM flights " + 
				"GROUP BY origin_airport_id, destination_airport_id ";
		
		/*anche come query
		 * SELECT ORIGIN_AIRPORT_ID as id1, DESTINATION_AIRPORT_ID as id2, AVG(DISTANCE) as avgg " + 
		...
		try {
			...
			while (rs.next()) {
				...
				CoppiaAirports c= new CoppiaAirports(a1, a2, rs.getDouble("peso")); 
				result.add(c); 
			}
